...
mpbl = ax.imshow(sim[0].data, origin='lower', vmin=-0.2, vmax=1, cmap='gray_r')
...
ax.grid(zorder=2, color='black')

fmt = {'color':'black', 'fontsize':12, 'xycoords':ax.get_transform('world')}
